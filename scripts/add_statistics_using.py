#!/usr/bin/env python3
"""
Скрипт для добавления using ClubDoorman.Services.Statistics в файлы
"""
...
def main():
    ...
    files_to_update = [
        ...
        'ClubDoorman/Services/UserCleanupService.cs',
        'ClubDoorman/Services/UserJoin/UserJoinService.cs',
