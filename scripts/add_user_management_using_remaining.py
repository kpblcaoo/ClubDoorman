#!/usr/bin/env python3
"""
Скрипт для добавления using ClubDoorman.Services.UserManagement в оставшиеся тестовые файлы
"""
...
def main():
    ...
    files_to_update = [
        ...
        'ClubDoorman.Test/TestInfrastructure/ApprovedUsersStorageTestFactory.cs',
        'ClubDoorman.Test/StepDefinitions/Common/AiAnalysisSteps.cs',
        'ClubDoorman.Test/TestKit/Builders/MockBuilders/UserManagerMockBuilder.cs',
        'ClubDoorman.Test/TestKit/Infra/TestKitAutoFixture.cs',
        'ClubDoorman.Test/TestInfrastructure/SuspiciousUsersStorageTestFactory.cs',
        ...
        'ClubDoorman.Test/TestKit/TestKit.AutoFixture.cs',
        'ClubDoorman.Test/TestInfrastructure/UpdateDispatcherTestFactory.cs',
