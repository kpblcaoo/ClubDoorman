    ...
    public static bool IsBoringGreeting(string message)
    {
        ...
        if (words.Length <= 5 && words.Length >= 2)
        {
            ...
            if (hasGreeting)
            {
                ...
                {
                    "можно", "можете", "может", "могу", "могла", "мог",
                    "доставка", "доставку", "доставить", "доставят", "доставляем",
                    "работаете", "работает", "работаем", "работу", "работать",
                    "время", "времени", "когда", "где", "сколько", "что", "какой", "какая", "какие",
                    "цена", "цену", "цены", "стоимость", "стоить", "стоит",
                    "заказ", "купить", "заказать", "заказывать", "заказали",
                    "услуга", "услуги", "услугу", "сервис", "помощь", "помочь",
