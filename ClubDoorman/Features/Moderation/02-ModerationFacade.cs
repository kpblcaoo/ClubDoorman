...
public class ModerationFacade : IModerationFacade
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if ((moderationResult.Action == ModerationAction.Delete || moderationResult.Action == ModerationAction.Report || moderationResult.Action == ModerationAction.Ban || moderationResult.Action == ModerationAction.Allow || moderationResult.Action == ModerationAction.RequireManualReview || moderationResult.Action == ModerationAction.RequireAiAnalysis) && 
            _appConfig.Effects.IsActionEnabled(moderationResult.Action) && 
            !_appConfig.Effects.LegacyFallback)
        {
